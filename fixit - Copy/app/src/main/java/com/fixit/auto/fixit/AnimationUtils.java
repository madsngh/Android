...
//        animatorSet.start();
    ...
    public static void animatelogo(//TextView logo,
                                   ImageView iv){
      //  YoYo.with(Techniques.RotateIn).duration(5000).playOn(logo);
        YoYo.with(Techniques.BounceIn).duration(5000).playOn(iv);
    }
